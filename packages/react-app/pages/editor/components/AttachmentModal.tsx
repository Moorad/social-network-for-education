...
export default function AttachmentModal({ open }: { open: boolean }) {
				...
				<div className='flex flex-col gap-2'>
					{attachments.map((e, i) => (
						<div className='flex bg-gray-100 p-4 items-center gap-4 rounded-md text-sm' key={i}>
							...
							<div className='ml-auto'><FontAwesomeIcon icon={faClose} /></div>

						</div>))}
				</div>
				<div className='flex gap-5 mt-6 text-sm'>
					<button className='bg-gray-400 py-2 px-5 rounded text-white'>Close</button>
