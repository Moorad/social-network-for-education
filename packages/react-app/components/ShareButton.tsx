				...
				{open &&
					<Popover.Panel className='absolute z-10 bg-white border-gray-300 border rounded-lg p-5 right-0 translate-x-1/2 top-10'>
						<div className='flex gap-5'>
							<div className='flex flex-col gap-2 items-center' onClick={() => copyText()}>
							...
							<a href={`mailto:?subject=${shareData.text}&amp;body=${shareData.url}`}>
							...
							<a href={`http://twitter.com/share?text=${shareData.text}&url=${shareData.url}`}>
								<div className='flex flex-col gap-2 items-center'>
